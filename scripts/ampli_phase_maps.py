...
start_time = '1992-01-01'    # starting date
...
#        latitude = []
       ...
       # print(amp_M2, pha_M2)
       # np.savetxt('./maps/amp_M2_'+str(tilenum)+'.txt', amp_M2)
       # np.savetxt('./maps/pha_M2_'+str(tilenum)+'.txt', pha_M2)
